...
//10. ?? (null 병합 연산자) 
//병합 연산자라고 하는데, 앞의 피연산자가 null 혹은 undefined라면 뒤 피연산자를 반환하고, 그렇지 않다면 앞의 피연산자를 반환한다. 즉 null, undefined 가 아닌 값을 찾아내는 연산자. 
//누군가가 값을 주었다.(어떤 값을 줄지 아무도 모른다.)
//동적타입이기에 모든 타입을 다 받아버린다.
//절대 받으면 안되는 것이다. null underfined 문제가 생김
